...
import com.team.todoapp.utils.JDBCUtils;
 ...
 //This class implements CRUD database operations for the database table todos.


public class TodoTlmpl implements TodoT {
	...
	public void insertTodo(Todo todo) throws SQLException {
		...
		// The connection will be closed automatically if you use the try-with-resource statement.
	...
	public Todo selectTodo(long todoId) {
		...
		try (Connection connection = JDBCUtils.getConnection();
				// Step 2: Using the connection object, create a statement.
				PreparedStatement preparedStatement = connection.prepareStatement(SELECT_TODO_BY_ID);) {
			preparedStatement.setLong(1, todoId);
			System.out.println(preparedStatement);
			// Step 3: Run the query or make a change to the query.
			ResultSet rs = preparedStatement.executeQuery();

			// Process the ResultSet object in step four.
			while (rs.next()) {
	...
	public List<Todo> selectAllTodos() {
		...
		// To prevent shutting resources, try-with-resources is used (boiler plate code)
